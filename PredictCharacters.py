...
for test in test_data:
    binary = DetectPlateV2.get_plate_area(test[0], wpod_net)
    column_list, characters = SegmentCharacters.get_number_area(binary)
    number = get_plate(model, column_list, characters)
    print("Check file %s which is %s - predict is %s" %(test[0], test[1], number))
